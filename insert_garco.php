...
$sql = "INSERT INTO usuario (data_nascimento ,nome, senha, email, tipo_usuario, rg, endereco, escolaridade, telefone, cpf ) VALUES  ('$nasci' ,'$nome', '$ss', '$email',2 , '$rg', '$endereco', '$escola', '$telefone', '$cpf')";
