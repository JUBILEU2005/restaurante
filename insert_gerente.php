...
$sql = "INSERT INTO usuario (data_nascimento ,nome, senha, email, tipo_usuario, rg, endereco, escolaridade, telefone, cpf ) VALUES  ('$nasci' ,'$nome', '$ss', '$email',3 , '$rg', '$endereco', '$escola', '$telefone', '$cpf')";
